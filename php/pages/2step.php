...
<body class="body__cart">
    ...
    <header class="cart__header"> 
        ...
        <line x1="158" y1="15.5" x2="248" y2="15.5" stroke="#232323" stroke-width="3"/>
            ...
            <h2 class="step-title marginauto">Código de descuento</h2>

            <form class="form__container" action="">

                <label class="form__label" for="name">
                    <input class="bordersolid form__input" type="text" id="name" placeholder="Introduce tu código de descuento">
                </label>
