...
<body class="body__cart">
    ...
    <header class="cart__header"> 
        ...
        <circle cx="17" cy="17" r="16.5" stroke="#232323"/>
        <path d="M16.9834 11.9922V22H15.7188V13.5713L13.1689 14.501V13.3594L16.7852 11.9922H16.9834Z" fill="#232323"/>
        ...
        <line x1="158" y1="15.5" x2="248" y2="15.5" stroke="#232323" stroke-width="3"/>
            ...
            <h2 class="step-title marginauto">Pago</h2>

            <form class= "form__container" action="">
                <h3 class=" marginauto tarjeta-title">Detalles de la Tarjeta</h3>
                
                <label class="form__label" for="numero">
                    <input  type="cc" class="bordersolid form__input" name="numero" rows="10" cols="50" placeholder="Nº de la tarjeta">
                </label>

                                
                <label class="form__label" for="nombre">
                    <input type="name" class="bordersolid form__input" name="nombre" rows="10" cols="50" placeholder="Nombre Completo">
                </label>

                                
                <label class="form__label" for="caducidad">
                    <input type="month"class="bordersolid form__input date" name="caducidad" rows="10" cols="50" placeholder="Caducidad">
                </label>

                <label class="form__label" for="cvc">
                    <input type="password"class="bordersolid form__input cvc" name="cvc" rows="10" cols="50" placeholder="CVC">
                </label>

            </form>
            <div class="check-text marginauto">
                <a class="cta-comprar p-large marginmed cta-black" href="thanks_page.php" alt="continuar"> Pagar </a>
            </div>
